...
GPP_ElectricCars_inclREN_Total <- mutate(GPP_ElectricCars_inclREN_Total, scenario="Electric cars")
...
GPP_Industry_Total <- mutate(GPP_Industry_Total, scenario="Industry")
