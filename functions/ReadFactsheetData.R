...
if (file.exists(paste0("data/",cfg$infile,"_proc.Rdata")) & !b.procdata) {
  ...
  vars <- fread("functions/factsheet/variables_xCut.csv",header=TRUE,stringsAsFactors=FALSE,sep='\n')
