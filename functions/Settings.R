...
energy_carrier_energy_2015            = c('Coal', 'Heavy oil', 'Light oil', 'Natural gas', 'Modern biofuels', 'Traditional biofuels', 'Nuclear', 'Solar/wind', 'Hydro-electricity')
energy_carrier_energy_incl_total_2015 = c('Coal', 'Heavy oil', 'Light oil', 'Natural gas', 'Modern biofuels', 'Traditional biofuels', 'Nuclear', 'Solar/wind', 'Hydro-electricity', 'Total')
energy_carrier_energy_3_3             = c('Coal', 'Heavy oil', 'Light oil', 'Natural gas', 'Modern biofuels', 'Traditional biofuels', 'Nuclear', 'Solar/wind', 'Hydro-electricity', 'Hydrogen')
energy_carrier_energy_incl_total_3_3  = c('Coal', 'Heavy oil', 'Light oil', 'Natural gas', 'Modern biofuels', 'Traditional biofuels', 'Nuclear', 'Solar/wind', 'Hydro-electricity', 'Hydrogen', 'Total')
...
energy_technology_34_3_3 = c('Solar PV power (central)', 'Solar PV power (decentral/residential)', 'Concentrated solar power', 'Onshore wind power', 'Offshore wind power', 'Wave power', 'Hydro power', 'Other renewables (tidal)', 'Geothermal power','Hydrogen to power','Nuclear', 'Free spot', 'Coal steam turbine', 'Oil steam turbine', 'NG open cycle turbine', 'Biomass steam turbine', 'Integrated gasification combined cycle', 'Oil combined cycle', 'NG combined cycle', 'Biomass combined cycle', 'Coal carbon capture and storage', 'Oil carbon capture and storage','NG carbon capture and storage', 'Biomass carbon capture and storage', 'Coal combined heat and power', 'Oil combined heat and power', 'NG combined heat and power', 'Biomass combined heat and power', 'Coal combined heat and power carbon capture and storage', 'Oil combined heat and power carbon capture and storage', 'NG combined heat and power carbon capture and storage', 'Biomass combined heat and power carbon capture and storage', 'Geothermal combined heat and power','Hydrogen')
energy_technology_incl_total_34_3_3 = c('Solar PV power (central)', 'Solar PV power (decentral/residential)', 'Concentrated solar power', 'Onshore wind power', 'Offshore wind power', 'Wave power', 'Hydro power', 'Other renewables (tidal)', 'Geothermal power','Hydrogen to power','Nuclear', 'Free spot', 'Coal steam turbine', 'Oil steam turbine', 'NG open cycle turbine', 'Biomass steam turbine', 'Integrated gasification combined cycle', 'Oil combined cycle', 'NG combined cycle', 'Biomass combined cycle', 'Coal carbon capture and storage', 'Oil carbon capture and storage','NG carbon capture and storage', 'Biomass carbon capture and storage', 'Coal combined heat and power', 'Oil combined heat and power', 'NG combined heat and power', 'Biomass combined heat and power', 'Coal combined heat and power carbon capture and storage', 'Oil combined heat and power carbon capture and storage', 'NG combined heat and power carbon capture and storage', 'Biomass combined heat and power carbon capture and storage', 'Geothermal combined heat and power','Hydrogen', 'Total')
...
energy_technology_24_3_3 = c('Solar PV power (central)', 'Solar PV power (decentral/residential)', 'Concentrated solar power', 'Onshore wind power', 'Offshore wind power', 'Wave power', 'Hydro power', 'Other renewables (tidal and geothermal power)', 'Geothermal power','Hydrogen to power','Nuclear', 'Free spot', 'Coal steam turbine', 'Oil steam turbine', 'NG open cycle turbine', 'Biomass steam turbine', 'Integrated gasification combined cycle', 'Oil combined cycle', 'NG combined cycle', 'Biomass combined cycle', 'Coal carbon capture and storage', 'Oil carbon capture and storage','NG carbon capture and storage', 'Biomass carbon capture and storage')
energy_technology_14_2015 = c('Solar','Wind', 'Hydro','Other Renewable','Nuclear','Coals','Coal CCS','Oil','Oil CCS','NG','NG CCS','Biomass','Biomass CCS', 'Total')
energy_technology_15_3_3 = c('Solar','Wind', 'Hydro','Other Renewable','Nuclear','Coal','Coal CCS','Oil','Oil CCS','NG','NG CCS','Biomass','Biomass CCS', 'Hydrogen', 'Total')
energy_technology_TPESelec_ren = c('Solar', 'Wind', 'Hydro', 'Other Renewable', 'Biomass', 'Biomass CCS')
energy_technology_TPESelec_nf = c('Solar', 'Wind', 'Hydro', 'Other Renewable','Nuclear', 'Biomass', 'Biomass CCS')
