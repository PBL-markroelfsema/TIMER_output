...
energy_carrier_innovative_28 = c('PV','CSP', 'Wind Onshore','Wind Offshore','Hydro','Other Renewable','Nuclear','8','Waste','Biomass CC','Coal + CS','Oil + CS','Natural gas + CS','Biomass + CS','CHP biomass','CHP biomass + CS')
...
energy_technology_solar = c('PV','CSP')
