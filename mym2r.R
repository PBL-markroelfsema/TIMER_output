...
lookup.mym.dimlabels = function(varname){
  ...
  return( switch(varname, 
    ...
    'main.em.EnergyProdTotal' = list(collist=list(regions28,energy_carrier_energy2), namecols=c('region','energy_carrier')),
    'main.em.RSE_USS' = list(collist=list(regions28,sector,energy_carrier_demand), namecols=c('region','sector', 'energy_carrier')),
    'main.em.dem.res.EnUseFunction_TURQ' = list(collist=list(regions28,population_groups,res_enduse_functions), namecols=c('region','population_group', 'enduse_function')),
    ...
    'main.em.dem.IVA' = list(collist=list(regions28), namecols=c('region')),
    NULL ) )
}
