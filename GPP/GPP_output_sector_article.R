...
# add arrow to figure representing NDC range
#NDC_year = c(2031, 2031)
#NDC_value = c(53.4, 55.9)
#NDC = data.frame(NDC_year,NDC_value, labels=c("year", "value"))
#NDC_min=data.frame(x=c(2030), y=c(53.4))

p <- ggplot() + geom_segment(mapping=aes(x=2031, y=53.4, xend=2031, yend=55.9), arrow=arrow(ends="both", type="closed"), size=2, color="darkgreen")
...
# FIGURE 2
# TO DO - add arrow to legend (set show.legin in geom_segment to TRUE)
